...
- `datasets/healthcare/nhia_state_social_health_insurance_agencies.json`
- `datasets/schemas/healthcare/nhia_state_social_health_insurance_agencies.schema.json`
- `datasets/metadata/healthcare/nhia_state_social_health_insurance_agencies.json`
- `datasets/metadata/healthcare/nhia_state_social_health_insurance_agencies_reconciliation/index.json`
