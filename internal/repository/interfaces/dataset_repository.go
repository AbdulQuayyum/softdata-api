...
type DatasetRepository interface {
	...
	ListPublic(ctx context.Context, filter models.DatasetListFilter) ([]models.Dataset, error)
	CountPublic(ctx context.Context, filter models.DatasetListFilter) (int64, error)
